...
const createRequest: CreateRequest = (url, method, data) => {
  ...
  return new Request(BASE_URL + requestUrl, { method, body: JSON.stringify(data?.body), headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning" : "true", "x-api-version" : "2" } })
}
